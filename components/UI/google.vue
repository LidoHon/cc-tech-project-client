...
<template>
  <button
    @click="handleClick"
    :disabled="isLoading"
    class="w-full flex items-center justify-center mt-4 text-gray-700 transition-colors duration-300 transform border rounded-full hover:bg-cyan-600 hover:ring-blue-500 hover:border-blue-500"
  >
